...
$('#styleSelector').append('' +
    ...
    '<ul>' +
        '<li>' +
            '<p class="selector-title main-title st-main-title"><b>Straight A</b></p>' +
            '<span class="text-muted">Online Education</span>'+
        '</li>' +
        '<li>' +
            '<p class="selector-title">Straight A is the best digital solution for the Sri-Lankan Educational Arena.</p>' +
        '</li>' +
        '<li>' +
...
'<ul>'+
    ...
    '<li class="text-center">' +
        '<span class="text-center f-18 m-t-15 m-b-15 d-block">Thank you for joining with Straight A !</span>' +
    '</li>' +
'</ul>'+
'');
