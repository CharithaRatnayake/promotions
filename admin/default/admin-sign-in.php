                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 auth-boxAdm" style="padding:0 5%; border-radius: 25px;">
                                        
                                        <div class="row m-b-20">
                                            <div class="col-md-12" style="padding: 6%;">
                                                <p class="text-center login-title">Login Here</p>
                                            </div>
                                        </div>
                                        <div class="form-group form-primary">
                                            <input type="text" name="username" id="username" class="form-control form-control-round" required="" placeholder="Your login Name">
                                            <span class="form-bar"></span>
                                        </div>
                                        <br> 
                                        <div class="form-group form-primary">  
                                            <input type="password" name="password" class="form-control form-control-round "
                                        ...
                                        <div class="row m-t-30">
                                            <div class="col-md-12">
                                                <button  type="submit"
                                                    class="btn btn-primary btn-md btn-block btn-round waves-effect waves-light text-center m-b-20" onclick="lsRememberMe()" name="login" style="background-color: #10a8e0;">Sign in</button>
                                            </div>
                                        </div>
                                    </div>
