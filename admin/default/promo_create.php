                        ...
                        <div class="d-inline"> 
                            ...
                            <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title">Promotion Entry </h4>
                                                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                            <span aria-hidden="true" onclick="window.location = 'index.php';" style=" font-size: 30px; ">&times;</span>
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form class="form-horizontal" name="AddForm" method="post" action="promotion_upd.php" onsubmit="return validateEntry('AddForm')" enctype='multipart/form-data'>
                                                                            <div class="form-group row">
                                                                                <label class="col-sm-3 col-form-label">Select Station</label> 
                                                                                <div class="col-sm-9" id="ss_grd">
                                                                                    <select class="form-control" id="Optsta" name="optsta" required>
                                                                                        <option value="" >Select Station</option>  
            <?php foreach($sta_all as $arr){echo '<option value="'. $arr->lid .'" >'. $arr->location .'</option>'; }?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>                                                                            
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control ucase" id="name" name="station" value="" placeholder="Station" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-sm-3 col-form-label">Select Promotion</label> 
                                                                                <div class="col-sm-9" >
                                                                                    <select class="form-control" id="Optpro" name="optpro" required>
                                                                                        <option value="0" >New Promotion</option>  
            <?php //foreach($sta_all as $arr){echo '<option value="'. $arr->lid .'" >'. $arr->location .'</option>'; }?>
                                                                                    </select>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="pro_ttl"  name="pro_ttl" value="" placeholder="Promotion Tittle" required>
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-sm-3 col-form-label">Discount</label>
                                                                                <div class="col-sm-9">
                                                                                    <input type="text" class="form-control" id="discount"  name="discount" value="" placeholder="Discount" required>
                                                                                </div>
                                                                            </div> 
                                                                            <div class="form-group row">
                                                                                <label class="col-sm-3 col-form-label">Promotion Pic</label>
                                                                                <div class="col-sm-9">
                                                                                   <input type="file" class="form-control" id="pic1" name="pro_pic1"> 
                                                                                   <input type="text" class="col-sm-12" style="color: blueviolet;border:none;" id="picx" value="" name="pro_picx" readonly=""> 
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-sm-3 col-form-label">From Time</label>
                                                                                <div class="col-sm-9">
                                                                                   <input type="datetime-local" class="form-control" id="fr_date" name="fr_date" placeholder="From Dates" value="" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
                                                                                <label class="col-sm-3 col-form-label">To Time</label>
                                                                                <div class="col-sm-9">
                                                                                   <input type="datetime-local" class="form-control" id="to_date" name="to_date" placeholder="To Date" value="" >
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group row">
